...
impl Client {
    ...
    /// ### Important
    /// 
    /// Transaction hashes in the stream are filled with a placeholder value of `TransactionHash::ZERO`.
    /// The consumer of the stream is responsible for computing the correct transaction hashes. 
