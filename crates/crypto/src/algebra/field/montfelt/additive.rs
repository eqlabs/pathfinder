use crate::algebra::field::montfelt::core::{adc, sbb};
use crate::MontFelt;
...
mod tests {
    ...
    #[test]
    fn test_add() {
        let a = MontFelt::from_hex("A");
        let b = MontFelt::from_hex("5");
        let c = a + b;
        assert_eq!(c, MontFelt::from_hex("F"));

        let a = MontFelt::P - MontFelt::ONE;
        let b = MontFelt::ZERO - MontFelt::ONE;
        assert_eq!(a, b);
    }
}
