...
pub mod core_addr {
    ...
    pub const GOERLI_TESTNET: [u8; 20] = Decoder::Hex.decode(b"de29d060D45901Fb19ED6C6e959EB22d8626708e");
    pub const GOERLI_INTEGRATION: [u8; 20] =
        Decoder::Hex.decode(b"d5c325D183C592C94998000C5e0EED9e6655c020");
    pub const SEPOLIA_TESTNET: [u8; 20] = Decoder::Hex.decode(b"E2Bb56ee936fd6433DC0F6e7e3b8365C906AA057");
    pub const SEPOLIA_INTEGRATION: [u8; 20] = Decoder::Hex.decode(b"4737c0c1B4D5b1A687B42610DdabEE781152359c");    
}
