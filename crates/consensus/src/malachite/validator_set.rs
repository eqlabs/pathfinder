...
impl malachite_types::ValidatorSet<MalachiteContext> for ValidatorSet {
    fn count(&self) -> usize {
        self.validators.len()
    }
    ...
    fn get_by_address(
        &self,
        address: &<MalachiteContext as malachite_types::Context>::Address,
    ) -> Option<&<MalachiteContext as malachite_types::Context>::Validator> {
