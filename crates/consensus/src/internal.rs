...
pub struct InternalParams<A> {
    ...
    pub address: A,
    pub threshold_params: ThresholdParams, /* TODO: Malachite types shouldn't be exposed to the
                                            * outside! ***** */
    pub value_payload: ValuePayload, /* TODO: Malachite types shouldn't be exposed to the
                                      * outside! ***** */
}
