...
rpc_call '{"jsonrpc":"2.0","id":"0","method":"starknet_getBlockByNumber","params":["latest"]}'

rpc_call '{"jsonrpc":"2.0","id":"1","method":"starknet_getBlockByHash","params":["latest","TXN_HASH"]}'
rpc_call '{"jsonrpc":"2.0","id":"1","method":"starknet_getBlockByNumber","params":["latest","TXN_HASH"]}'

rpc_call '{"jsonrpc":"2.0","id":"1","method":"starknet_getBlockByHash","params":["latest","FULL_TXNS"]}'
rpc_call '{"jsonrpc":"2.0","id":"1","method":"starknet_getBlockByNumber","params":["latest","FULL_TXNS"]}'

rpc_call '{"jsonrpc":"2.0","id":"1","method":"starknet_getBlockByHash","params":["latest","FULL_TXN_AND_RECEIPTS"]}'
rpc_call '{"jsonrpc":"2.0","id":"1","method":"starknet_getBlockByNumber","params":["latest","FULL_TXN_AND_RECEIPTS"]}'
