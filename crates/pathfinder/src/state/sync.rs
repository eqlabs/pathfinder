        ...
        tokio::task::block_in_place(|| {
            ...
            let notification = match event {
                ...
                DownloadedBlock(
                    ...
                    metrics::histogram!("block_processing_duration_seconds").record(update_t.as_secs_f64());
                    metrics::gauge!("block_latency").set(latency as f64);
                    metrics::gauge!("block_time").set((block_timestamp.get() - latest_timestamp.get()) as f64);
