...
pub(crate) mod tests {
    ...
    pub(crate) mod fixtures {
        ...
        pub mod expected_output_0_13_1_1 {
            ...
            ) -> crate::dto::SimulatedTransaction {
                crate::dto::SimulatedTransaction(
                    pathfinder_executor::types::TransactionSimulation {
                        fee_estimation: pathfinder_executor::types::FeeEstimate {
            ...
            pub fn universal_deployer(
                ...
                crate::dto::SimulatedTransaction(
                    pathfinder_executor::types::TransactionSimulation{
                        ...
                        trace: pathfinder_executor::types::TransactionTrace::Invoke(pathfinder_executor::types::InvokeTransactionTrace {
                            validate_invocation: Some(universal_deployer_validate(
                                account_contract_address,
                                universal_deployer_address,
                            )),
                            execute_invocation: pathfinder_executor::types::ExecuteInvocation::FunctionInvocation(
