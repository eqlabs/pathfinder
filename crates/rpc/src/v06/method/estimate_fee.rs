    ...
    mod in_memory {
        ...
        async fn declare_deploy_and_invoke_sierra_class() {
            ...
            let declare_expected = FeeEstimate {
                ...
                l2_gas_consumed: 280000.into(),
                l2_gas_price: 1.into(),
                overall_fee: 282768.into(),
                unit: PriceUnit::Wei,
            };
            let deploy_expected = FeeEstimate {
                ...
                l1_data_gas_consumed: None,
                l1_data_gas_price: None,
                l2_gas_consumed: 340000.into(),
                l2_gas_price: 1.into(),
                overall_fee: 343020.into(),
                unit: PriceUnit::Wei,
            };
