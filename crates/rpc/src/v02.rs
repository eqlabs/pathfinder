...
pub fn register_methods(context: RpcContext) -> anyhow::Result<Methods> {
    let methods = crate::module::Module::new(context)
        .register_method("starknet_call", method::call::call)?
        .register_method_with_no_input("starknet_chainId", method::chain_id::chain_id)?
        .register_method(
        ...
        .register_method("starknet_getClass", method::get_class::get_class)?
        .register_method("starknet_getClassAt", method::get_class_at::get_class_at)?
        .register_method(
            "starknet_getClassHashAt",
            method::get_class_hash_at::get_class_hash_at,
        )?
        .register_method("starknet_getEvents", method::get_events::get_events)?
        .register_method("starknet_estimateFee", method::estimate_fee::estimate_fee)?
        .register_method("starknet_getNonce", method::get_nonce::get_nonce)?
        ...
        .register_method_with_no_input("starknet_syncing", method::syncing::syncing)?
        .register_method(
