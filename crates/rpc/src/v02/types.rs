            ...
            fn broadcasted_transaction() {
                ...
                let txs = vec![
                    BroadcastedTransaction::Declare(BroadcastedDeclareTransaction {
                        ...
                        nonce: TransactionNonce(felt!("08")),
                        contract_class: contract_class.clone(),
                        sender_address: ContractAddress::new_or_panic(felt!("0a")),
                    }),
                    BroadcastedTransaction::Deploy(BroadcastedDeployTransaction {
                        version: TransactionVersion(ethers::types::H256::from_low_u64_be(0x0)),
                        contract_address_salt: ContractAddressSalt(felt!("dd")),
                        constructor_calldata: vec![ConstructorParam(felt!("11"))],
                        contract_class,
                    }),
                    ...
                    BroadcastedTransaction::Invoke(BroadcastedInvokeTransaction::V1(
                        BroadcastedInvokeTransactionV1 {
                            ...
                            signature: vec![TransactionSignatureElem(felt!("07"))],
                            nonce: TransactionNonce(felt!("08")),
                            sender_address: ContractAddress::new_or_panic(felt!("0aaa")),
                            calldata: vec![CallParam(felt!("ff"))],
                        },
                    )),
                    BroadcastedTransaction::Invoke(BroadcastedInvokeTransaction::V1(
        ...
        mod serde {
            ...
            fn transaction() {
                let common = CommonTransactionProperties {
                    hash: StarknetTransactionHash(felt!("04")),
                    max_fee: Fee(ethers::types::H128::from_low_u64_be(0x5)),
                    version: TransactionVersion(ethers::types::H256::from_low_u64_be(0x0)),
                    signature: vec![TransactionSignatureElem(felt!("07"))],
                    nonce: TransactionNonce(felt!("08")),
                ...
                let transactions = vec![
                    Transaction::Declare(DeclareTransaction {
                        common: common.clone(),
                        class_hash: ClassHash(felt!("09")),
                        sender_address: ContractAddress::new_or_panic(felt!("0a")),
                    }),
                    Transaction::Invoke(InvokeTransaction::V0(InvokeTransactionV0 {
                        common: CommonInvokeTransactionProperties {
                            hash: StarknetTransactionHash(felt!("0b")),
                            max_fee: Fee(ethers::types::H128::from_low_u64_be(0x999)),
                            signature: vec![TransactionSignatureElem(felt!("0777"))],
                            nonce: TransactionNonce(felt!("dd")),
                        },
                        contract_address: ContractAddress::new_or_panic(felt!("0b")),
                        entry_point_selector: EntryPoint(felt!("0c")),
                        calldata: vec![CallParam(felt!("0d"))],
                    })),
                    Transaction::Invoke(InvokeTransaction::V1(InvokeTransactionV1 {
                        common: CommonInvokeTransactionProperties {
                            hash: StarknetTransactionHash(felt!("0bbb")),
                            max_fee: Fee(ethers::types::H128::from_low_u64_be(0x9999)),
                            signature: vec![TransactionSignatureElem(felt!("0eee"))],
                            nonce: TransactionNonce(felt!("de")),
                        },
                        sender_address: ContractAddress::new_or_panic(felt!("0c")),
                        calldata: vec![CallParam(felt!("0ddd"))],
                    })),
                    Transaction::Deploy(DeployTransaction {
                        hash: StarknetTransactionHash(felt!("0e")),
                        class_hash: ClassHash(felt!("10")),
                        version: TransactionVersion(ethers::types::H256::from_low_u64_be(1)),
                        contract_address_salt: ContractAddressSalt(felt!("ee")),
                        constructor_calldata: vec![ConstructorParam(felt!("11"))],
                    }),
                    Transaction::L1Handler(L1HandlerTransaction {
                        hash: StarknetTransactionHash(felt!("0f")),
                        version: TransactionVersion(ethers::types::H256::from_low_u64_be(1)),
                        nonce: common.nonce,
                        contract_address: ContractAddress::new_or_panic(felt!("0fff")),
                        entry_point_selector: EntryPoint(felt!("0f")),
                        calldata: vec![CallParam(felt!("0f"))],
                    }),
                ];
