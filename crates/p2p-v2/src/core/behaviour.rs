...
/// This behaviour groups all the core behaviours common for all p2p network
/// implementations, except for connection management which is done by the
/// outer wrapper [`Behaviour`].
#[derive(NetworkBehaviour)]
pub struct Inner<B: NetworkBehaviour> {
...
impl<B: NetworkBehaviour> Behaviour<B> {
    pub fn builder(keypair: identity::Keypair, chain_id: ChainId, cfg: Config) -> Builder<B> {
